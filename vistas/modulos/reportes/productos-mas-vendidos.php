...
$colores = array("#00202e", "#003f5c", "#2c4875", "#8a508f", "#bc5090", "#ff6361", "#ff8531", "#ffa600", "#ffd380", "#fbf2c4");
            ...
            <div class="col-md-5">
                ...
                <ul class="chart-legend clearfix">
                    ...
                    for ($i = 0; $i < 10; $i++) {
                        ...
                        echo ' <li><i class="fa fa-circle" style="color:' . $colores[$i] . ';"></i> ' . $productos[$i]["descripcion"] . '</li>';
